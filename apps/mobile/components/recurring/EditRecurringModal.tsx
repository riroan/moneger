...
import { formatAmountInput, formatNumber, AMOUNT_LIMITS } from '@moneger/shared';
import CategoryDropdown from '../common/CategoryDropdown';
import { categoryApi, type CategoryWithBudget, type RecurringExpense } from '../../lib/api';

export type RecurringForEdit = RecurringExpense;

interface EditRecurringModalProps {
  visible: boolean;
  userId: string;
  expense: RecurringForEdit | null;
  onClose: () => void;
  onSubmit: (data: {
    description: string;
    amount: number;
...
export function EditRecurringModal({
  ...
  const confirmDelete = () => {
    ...
    Alert.alert(
      '고정비 삭제',
      `'${expense.description}'을(를) 삭제하시겠습니까?\n\n이미 생성된 거래 내역은 유지됩니다.`,
      [
      ...
      >
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            <Text style={styles.title}>고정비 수정</Text>
